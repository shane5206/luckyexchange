...
export const metadata: Metadata = {
  ...
  description: "Terms and Conditions of Block Treasure N.V.",
};
    ...
    <div className="container py-16">
      <article className="prose prose-slate mx-auto max-w-3xl">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground text-lg">Last updated: Aug 25th, 2023</p>
        </div>
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="mb-4">
              The Service is owned by Block Treasure N.V., a limited liability company registered in Curacao with company registration number 162195, with registered address at Zuikertuintjeweg (Zuikertuin Tower), Willemstad, Curacao (&quot;Company&quot;), licensed in Curaçao under Gaming Services Provider N.V. license # 365/JAZ which is governed solely by the laws of Curacao exclusively.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">3. Your Obligations</h2>
            <p className="mb-4">
              You acknowledge that at all times when accessing the Website and using the Service:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>You are is over 18, or the legal age at which gambling, or gaming activities are allowed under the law or jurisdiction that applies to you. We reserve the right to request proof of age documents from you at any time.</li>
              ...
              <li>You are a resident in a jurisdiction that allows gambling. You are not a resident of any country in which access to online gambling to its residents or to any person within such country is prohibited. It is your sole responsibility to ensure that your use of the service is legal.</li>
              <li>You may not use a VPN, proxy or similar services or devices that mask or manipulate the identification of your real location.</li>
              ...
              <li>You must generally act in good faith in relation to us of the Service at all times and for all bets made using the Service.</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">4. Restricted use</h2>
            <p className="mb-4">4.1. You must not use the Service:</p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>If you are a resident of one of the following countries, or accessing the Website from one of the following countries:
                <ul className="list-disc pl-6 mt-2">
                  <li>United States of America and its territories,</li>
                  <li>France and its territories,</li>
                  <li>Netherlands and its territories and countries that form the Kingdom of Netherlands, including Bonaire, Sint Eustatius, Saba, Aruba, Curaçao and Sint Maarten,</li>
              ...
              <li>To collect nicknames, e-mail addresses and/or other information of other Customers by any means (for example, by sending spam, other types of unsolicited emails or the unauthorised framing of, or linking to, the Service);</li>
            ...
            <div className="mt-6">
              <p className="mb-4">4.2. You cannot sell or transfer your account to third parties, nor can you acquire a player account from a third party.</p>
              <p className="mb-4">4.3. You may not, in any manner, transfer funds between player accounts.</p>
              <p className="mb-4">4.4. We may immediately terminate your Account upon written notice to you if you use the Service for unauthorised purposes. We may also take legal action against you for doing so in certain circumstances.</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">5. Registration</h2>
            <p className="mb-4">You agree that at all times when using the Service:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">6. Your Account</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>Accounts could use several currencies, in this case all Account balances and transactions appear in the currency used for the transaction.</li>
              ...
              <li>We reserve the right to close or suspend any Account without prior notice and return all funds. Contractual obligations already matured will however be honoured.</li>
              ...
              <li>You must inform us as soon as you become aware of any errors with respect to your Account.</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">7. Inactive Accounts</h2>
            <p className="mb-4">7.1. We will charge you a fee of €5 (or currency equivalent) per calendar month (Inactive Account Fee) if:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>you have not logged into your Account or logged out from your Account, or used the Service, or made any bet in any section of the Service for twelve consecutive months or more (Account Activity);</li>
              <li>and your Account is in credit.</li>
            </ul>
            <p className="mt-4">7.2. You will be notified that we will start charging you the fees on the eleventh month of inactivity and you will always have the option to log in and withdraw your funds.</p>
            <p className="mt-4">7.3. The Inactive Account Fee will be withdrawn from your Account on a monthly basis to the extent that your Account remains in credit and only for the period during which there remains no Account Activity after the initial twelve month period has passed. If the Inactive Account Fee is due to be withdrawn from your Account and the balance of your Account is less than €5 (or equivalent currency), the Inactive Account Fee shall comprise the remaining funds in your Account.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">8. Deposit of Funds</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>All deposits should be made from an account or payment system or credit card that is registered in your own name, and any deposits made in any other currency will be converted using the daily exchange rate obtained from oanda.com, or at our own bank&apos;s or our payment processor&apos;s prevailing rate of exchange following which your Account will be deposited accordingly. Note that some payment systems may apply additional currency exchange fees which will be deducted from the sum of your deposit.</li>
              <li>Fees and charges may apply to customer deposits and withdrawals, which can be found on the Website. In most cases we absorb transaction fees for deposits to your Obset.com Account. You are responsible for your own bank charges that you may incur due to depositing funds with us.</li>
              <li>Company is not a financial institution and uses a third party electronic payment processors to process credit and debit card deposits; they are not processed directly by us. If you deposit funds by either a credit card or a debit card, your Account will only be credited if we receive an approval and authorisation code from the payment issuing institution. If your card issuer gives no such authorisation, your Account will not be credited with those funds.</li>
              ...
              <li>If you decide to accept any of our promotional or bonus offer by entering a bonus code during deposit, you agree to the Terms of Bonuses and terms of each specific bonus.</li>
              <li>Funds originating from criminal and/or illegal and/or unauthorized activities must not be deposited with us.</li>
              <li>If you deposit using your credit card, it is recommended that you retain a copy of Transaction Records and a copy of these Terms.</li>
              <li>Internet Gambling may be illegal in the jurisdiction in which you are located; if so, you are not authorized to use your payment card to deposit on this site. It is your responsibility to know the laws concerning online gambling in your country of domicile.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">9. Withdrawal of Funds</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>You may withdraw any unutilized and cleared funds held in your player account by submitting a withdrawal request in accordance with our withdrawal conditions. The minimum withdrawal amount per transaction is € 10 (or equivalent in other currency) with the exception of an account closure in which case you may withdraw the full balance.</li>
              <li>There are no withdrawal commissions if you roll over (wager) the deposit at least 1 time. Otherwise we are entitled to deduct a 8% fee with minimum sum of 4 euro (or equivalent in your account currency) in order to combat money laundering.</li>
              <li>We reserve the right to request photo ID, address confirmation or perform additional verification procedures (request your selfie, arrange a verification call etc.) for the purpose of identity verification prior to granting any withdrawals from your Account. We also reserve our rights to perform identity verification at any time during the lifetime of your relationship with us.</li>
              <li>All withdrawals must be made to the original debit, credit card, bank account, method of payment used to make the payment to your Account. We may, and always at our own discretion, allow you to withdraw to a payment method from which your original deposit did not originate. This will always be subject to additional security checks.</li>
              <li>Should you wish to withdraw funds but your account is either inaccessible, dormant, locked or closed, please contact our Customer Service Department.</li>
              <li>In cases when your balance is at least 10 times larger than the total sum of your deposits, you will be limited to € 5,000 (or currency equivalent) for withdrawal per month. In other cases the maximum withdrawal amount per month is € 10,000.</li>
              <li>Please note that we cannot guarantee successful processing of withdrawals or refunds in the event if you breach the Restricted use policy stated in Clauses 3.3 and 4.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">10. Payment Transactions and Processors</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">11. Errors</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">12. Rules of Play, refunds and cancellations</h2>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>All results posted shall be final after 72 hours and no queries will be entertained after that period of time. Within 72 hours after results are posted, we will only reset/correct the results due to human error, system error or mistakes made by the referring results source.</li>
              ...
              <li>If a draw occurs in a game where a draw option is offered all stakes on a team win or lose will be lost. If a draw option is not offered then everyone receives a refund in the outcome of a draw on the match. And if a draw option has not been made available, then extra time will count, if played.</li>
              <li>If a result cannot be validated by us, for instance if the feed broadcasting the event is interrupted (and cannot be verified by another source) then at our election, the wagers on that event will be deemed invalid and wagers refunded.</li>
              ...
              <li>The start dates and times displayed on the Website for eSport matches are an indication only and are not guaranteed to be correct. If a match is suspended or postponed, and not resumed within 72 hours from the actual scheduled start time, the match will have no action and wagers will be refunded. The exception being any wager on whether a team/player advances in a tournament, or wins the tournament, will have action regardless of a suspended or postponed match.</li>
              <li>If an event is posted by us with an incorrect date, all wagers have action based on the date announced by the governing body.</li>
              <li>If a team is using stand-ins, the result is still valid as it was the team&apos;s choice to use the stand-ins.</li>
              <li>Company reserves the right to remove events, markets and any other products from the Website.</li>
              <li>In-depth explanation of our sports betting rules is on the separate page: SPORTS BETTING RULES</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">13. Communications and Notices</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>All communications and notices to be given under these Terms by you to us shall be sent using a Customer Support form on the Website.</li>
              ...
              <li>From time to time, we may contact you by email for the purpose of offering you information about betting, unique promotional offerings, and other information from Obset.com. You agree to receive such emails when you agree to these Terms when registering at the Website. You can choose to opt out of receiving such promotional offerings from us at any time by submitting a request to the Customer Support.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">14. Matters Beyond Our Control</h2>
            <p className="mb-4">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>any monies deposited in your Account which are not winnings will be returned to you OR retained until you turn 18 years old at our sole discretion. We reserve the right to deduct payment transaction fees from the amount to return, including transaction fees for deposits to your LuckySports.cloud account which we covered.</li>
            </ul>

            <p className="mt-6">16.2. This condition also applies to you if you are over the age of 18 years but you are placing your bets within a jurisdiction which specifies a higher age than 18 years for legal betting and you are below that legal minimum age in that jurisdiction.</p>
            <p className="mt-4">16.3. In the event we suspect you are in breach of the provisions of this Clause or are attempting to rely on them for a fraudulent purpose, we reserve the right to take any action necessary in order to investigate the matter, including informing the relevant law enforcement agencies.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">17. Fraud</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">18. Intellectual Property</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>Any unauthorised use of our name and logo may result in legal action being taken against you.</li>
              <li>As between us and you, we are the sole owners of the rights in and to the Service, our technology, software and business systems (the &quot;Systems&quot;) as well as our odds.
                <ul className="list-disc pl-6 mt-2">
                  <li>you must not use your personal profile for your own commercial gain (such as selling your status update to an advertiser); and when selecting a nickname for your Account we reserve the right to remove or reclaim it if we believe it appropriate.</li>
                </ul>
              </li>
              <li>You may not use our URL, trademarks, trade names and/or trade dress, logos (&quot;Marks&quot;) and/or our odds in connection with any product or service that is not ours, that in any manner is likely to cause confusion among Customers or in the public or that in any manner disparages us.</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">19. Your License</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>Subject to these Terms and your compliance with them, we grant to you a non-exclusive, limited, non transferable and non sub-licensable license to access and use the Service for your personal non-commercial purposes only. Our license to you terminates if our agreement with you under these Terms ends.</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">20. Your Conduct and Safety</h2>
            <p className="mb-4">20.1. For your protection and protection of all our Customers, the posting of any content on the Service, as well as conduct in connection therewith and/or the Service, which is in any way unlawful, inappropriate or undesirable is strictly prohibited (&quot;Prohibited Behaviour&quot;).</p>
            ...
            <p className="mb-4">20.3. Prohibited Behaviour includes, but is not limited to, accessing or using the Service to:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>promote or share information that you know is false, misleading or unlawful;</li>
              <li>conduct any unlawful or illegal activity, such as, but not limited to, any activity that furthers or promotes any criminal activity or enterprise, violates another Customer&apos;s or any other third party&apos;s privacy or other rights or that creates or spreads computer viruses;</li>
              ...
              <li>create Accounts on the Website by automated means or under false or fraudulent pretences;</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">21. Links to Other Websites</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">22. Complaints</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>If you have any concerns or questions regarding these Terms you should contact our Customer Service Department via the links on the Website and use your Registered Email Address in all communication with us.</li>
              <li>NOTWITHSTANDING THE FOREGOING, WE TAKE NO LIABILITY WHATSOEVER TO YOU OR TO ANY THIRD PARTY WHEN RESPONDING TO ANY COMPLAINT THAT WE RECEIVED OR TOOK ACTION IN CONNECTION THEREWITH.</li>
              ...
              <li>Disputes must be lodged within three (3) days from the date the wager in question has been decided. No claims will be honoured after this period. The Customer is solely responsible for their Account transactions.</li>
              <li>In the event of a dispute arising between you and us our Customer Service Department will attempt to reach an agreed solution. Should our Customer Service Department be unable to reach an agreed solution with you, the matter will be escalated to our management.</li>
              <li>Should all efforts to resolve a dispute to the Customer&apos;s satisfaction have failed, the Customer has the right to lodge a complaint with our licensing body Gaming Services Provider N.V.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">24. Severability</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">25. Breach of These Terms</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">26. General Provisions</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>Term of agreement. These Terms shall remain in full force and effect while you access or use the Service or are a Customer or visitor of the Website. These Terms will survive the termination of your Account for any reason.</li>
              <li>Gender. Words importing the singular number shall include the plural and vice versa, words importing the masculine gender shall include the feminine and neuter genders and vice versa and words importing persons shall include individuals, partnerships, associations, trusts, unincorporated organisations and corporations.</li>
              <li>Waiver. No waiver by us, whether by conduct or otherwise, of a breach or threatened breach by you of any term or condition of these Terms shall be effective against, or binding upon, us unless made in writing and duly signed by us, and, unless otherwise provided in the written waiver, shall be limited to the specific breach waived. The failure of us to enforce at any time any term or condition of these Terms shall not be construed to be a waiver of such provision or of the right of us to enforce such provision at any other time.</li>
              <li>Acknowledgement. By hereafter accessing or using the Service, you acknowledge having read, understood and agreed to each and every paragraph of these Terms. As a result, you hereby irrevocably waive any future argument, claim, demand or proceeding to the contrary of anything contained in these Terms.</li>
              <li>Language. In the event of there being a discrepancy between the English language version of these rules and any other language version, the English language version will be deemed to be correct.</li>
              <li>Governing Law. These Terms are governed by the law in force in Curaçao.</li>
              <li>Entire agreement. These Terms constitute the entire agreement between you and us with respect to your access to and use of the Service, and supersedes all other prior agreements and communications, whether oral or written with respect to the subject matter hereof.</li>
            </ul>
          </section>
        </div>
      </article>
